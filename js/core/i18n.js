...
const NL = {
  ...
  "nav.compassReady": "Westkompas live",
  ...
  "nav.compassError": "Kompassensorfout",
  ...
  "meta.tekno.description": "Tekno-collectief van Kwartier West: artiesten, evenementen en boekingen.",
  "meta.hiphop.description": "Hip hop-collectief van Kwartier West: artiesten, evenementen en boekingen.",
  "meta.events.title": "Kwartier West - Evenementen",
  "meta.events.description": "Evenementenhub met Tekno- en Hip hop-line-ups, tickets en officiele sociale bronnen.",
  ...
  "events.filter.allEvents": "Alle evenementen",
  "events.section.sources": "Officiele sociale feed",
  ...
  "artist.section.live": "Live-richting",
  "booking.initial": "Gebruik het formulier om een volledige boekingspayload te genereren.",
  ...
  "booking.validate.single": "Selecteer exact 1 artiest voor een solo boeking.",
  "booking.validate.multiple": "Selecteer minstens 2 artiesten voor een boeking met meerdere artiesten.",
  "booking.result.title": "Boekingsaanvraag klaar",
  "booking.loadArtistsError": "Artiesten konden niet geladen worden. Boekingsformulier tijdelijk offline.",
  "tekno.hero.desk": "Open centrale boekingsdesk",
  "hiphop.hero.desk": "Open centrale boekingsdesk",
  "tekno.events.cta": "Open globale evenementenhub",
  "hiphop.events.cta": "Open globale evenementenhub",
  "events.hero.lead": "Een feed. Twee kanten.",
  "events.loading": "Evenementen laden...",
  "events.error": "Evenementen konden niet geladen worden.",
  "events.none": "Nog geen evenementen gepubliceerd.",
  ...
  "contact.hero.lead": "Boekingen, productie en partnercontact.",
  "contact.tile.bookings.meta": "Artiesten en collectieven",
  "contact.tile.bookings.body": "Verstuur solo-, multiple- of collectiefaanvragen via een centrale intake.",
  "contact.tile.integration.body": "Boekingen, evenementen en winkel draaien al op app-klare payloadcontracten.",
  "manifest.rules.two": "Evenementen worden geprogrammeerd op kwaliteit en veiligheid, niet op hype.",
  "manifest.rules.four": "Data uit web, boekingsflow en evenementen staat klaar voor app-integratie.",
  "manifest.why.title": "Waarom twee kanten",
  "manifest.why.body": "Tekno en Hip hop vragen een andere podiumtaal, maar delen dezelfde infrastructuur: planning, productie, boekingsdiscipline en community-opbouw.",
  "manifest.rules.title": "Onze regels",
  "manifest.platform.two": "Toont evenementen met officiele sociale bronnen als oorsprong.",
  ...
  "meta.tickets.description": "Ticketing- en toegangsinfo voor Kwartier West-evenementen.",
