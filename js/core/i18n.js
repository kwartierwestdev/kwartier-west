...
const EN = {
  ...
  "nav.compassReady": "West compass live",
  ...
  "nav.compassHeading": "West direction {angle} deg",
...
const NL = {
  ...
  "meta.events.description": "Evenementenhub met Tekno- en Hip hop-line-ups, tickets en officiele bronlinks.",
  ...
  "tekno.events.cta": "Open de evenementenhub",
  ...
  "hiphop.events.cta": "Open de evenementenhub",
  ...
  "events.source.live": "Live synchronisatie actief.",
  "events.source.ready": "Live synchronisatie klaar.",
  ...
  "artist.section.live": "Live-aanpak",
  ...
  "booking.initial": "Vul je aanvraag in. Je krijgt meteen een duidelijke samenvatting.",
  "booking.type.single.label": "Enkele artiest",
  "booking.type.single.hint": "Boek exact één artiest.",
  ...
  "booking.form.helper": "Na verzenden tonen we je een samenvatting die je direct kunt doorsturen.",
  "booking.form.placeholder.eventName": "Warehouse Pressure Night",
  "booking.form.placeholder.city": "Roeselare",
  ...
  "booking.validate.single": "Selecteer exact één artiest voor een solo boeking.",
  ...
  "booking.result.mail": "Open e-mailontwerp",
  ...
  "booking.summary.budget": "Budget",
  "booking.summary.contact": "Contact",
  "booking.summary.json": "JSON-overzicht",
  ...
  "contact.hero.events": "Open evenementenhub",
  "contact.tile.bookings.title": "Boekingen",
  "contact.tile.bookings.meta": "Artiesten en collectieven",
  "contact.tile.bookings.body": "Verstuur solo-, multiple- of collectiefaanvragen via één intake.",
  ...
  "manifest.hero.title": "Manifest",
  "manifest.hero.lead": "Twee kanten. Eén standaard.",
  ...
  "manifest.platform.three": "Combineert labelmerch en artiestendrops in één winkel.",
  ...
  "tickets.hero.events": "Open evenementenhub",
